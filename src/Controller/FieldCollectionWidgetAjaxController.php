...
class FieldCollectionWidgetAjaxController extends FormAjaxController {
  ...
  public function remove(Request $request) {
    ...
    if (empty($request_form_build_id) ||
        $form_build_id !== $request_form_build_id)
    {
      // Invalid request.
      ...
      return $response->addCommand(
        new ReplaceCommand(NULL, drupal_render($status_messages)));
    }
    ...
    try {
      ...
      drupal_set_message(t(
        ...
        'reloading the page and submitting again.'), 'error');
